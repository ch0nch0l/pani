...
package com.skydoves.pani.ui.fragments.main
...
import com.skydoves.pani.models.Alarm
import com.skydoves.pani.persistence.sqlite.SqliteManager
import com.skydoves.pani.ui.activities.main.MakeAlarmActivity
import com.skydoves.pani.ui.adapters.AlarmFragmentAdapter
import com.skydoves.pani.ui.viewholders.AlarmViewHolder
    ...
    try {
      if (cursor != null && cursor.count > 0 && cursor.moveToLast()) {
        do {
          ...
          val alarmModel = Alarm(requestCode, sday, "$startTime ~ $endTime", "অন্তর : " + interval + "সময়")
  ...
  private val delegate = object : AlarmViewHolder.Delegate {
    override fun onConfirm(alarmModel: Alarm) {
      try {
        ...
        Toast.makeText(context, "অ্যালার্ম মুছে ফেলা হয়েছে", Toast.LENGTH_SHORT).show()

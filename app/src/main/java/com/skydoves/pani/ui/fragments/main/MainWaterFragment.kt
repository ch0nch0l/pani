...
import com.skydoves.pani.services.receivers.LocalWeather
import com.skydoves.pani.ui.activities.main.SelectDrinkActivity
import com.skydoves.pani.utils.DateUtils
import com.skydoves.pani.utils.FillableLoaderPaths
import com.skydoves.pani.utils.NetworkUtils
...
class MainWaterFragment : Fragment() {
  ...
  private fun onRefresh() {
    if (NetworkUtils.isNetworkAvailable(mContext!!)) {
      ...
      Toast.makeText(mContext, "আপনার নেটওয়ার্ক চেক করুন!", Toast.LENGTH_SHORT).show()
  }

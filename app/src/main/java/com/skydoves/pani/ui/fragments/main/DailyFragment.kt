...
import com.skydoves.pani.consts.CapacityDrawable
...
import com.skydoves.pani.ui.adapters.DailyDrinkAdapter
import com.skydoves.pani.ui.viewholders.DailyDrinkViewHolder
  ...
  private fun dateMoveButton(v: View) {
    when (v.id) {
      ...
      R.id.next -> if (dateCount < 0) {
        ...
        Toast.makeText(context, "আগামীকালের কোন রেকর্ড সংরক্ষিত নেই", Toast.LENGTH_SHORT).show()
    }
  }
